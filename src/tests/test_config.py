...
TEST_2_MAX_FREQ = [433080, 433270, 433870] # [433080, 433170, 433270, 433570, 433870, 434070] # 6
TEST_2_TRANSMIT_RATES = [1, 6, 12] # [1,4,8,12,15] # 5
...
TEST_4_NUM_CHANNELS = [10,42] 
TEST_4_TRANSMIT_RATES = [1,10]
